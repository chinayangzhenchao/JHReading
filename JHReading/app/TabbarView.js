    ...
    render() {
        return (
            <TabNavigator>
                ...
                {this._createTabbarItem('secondVC', 'icon_tabbar_misc', 'icon_tabbar_misc_selected', '点点')}
                {this._createTabbarItem('threeVC', 'icon_tabbar_nearby_normal', 'icon_tabbar_nearby_selected', '附近')}
