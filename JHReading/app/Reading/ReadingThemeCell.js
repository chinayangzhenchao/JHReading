...
export default class ReadingThemeCell extends Component {
    render() {
        return (
            <TouchableOpacity style={styles.rowStyle} onPress={this.props.clickCell(this.props.rowData.article_link)}>
                <Image source={{uir: this.props.rowData.img_url}} style={styles.imageStyle}/>
