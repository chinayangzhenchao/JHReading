            ...
            if (this.props.centerTitle) {//有图片和文字
                return (
                    <TouchableOpacity style={styles.centerViewStyle}>
                        ...
                        <Image source={{uri: this.props.centerIcon}} style={styles.iconStyle}/>
                    </TouchableOpacity>
                )
            } else {
                return (//只有图片
                    <TouchableOpacity style={styles.centerViewStyle}>
                        <Image source={{uri: this.props.centerIcon}} style={styles.centerIconStye}/>
                    </TouchableOpacity>
                )
            }
        } else if (this.props.centerTitle) {//只有文字
            return (
                <View style={styles.centerViewStyle}>centerIconStyle
                    <Text style={styles.centerTextStyle}>{this.props.centerTitle}</Text>
                </View>
            )
        } else {//图片和文字都没有
